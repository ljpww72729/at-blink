...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.ljpww72729.atblinkcontroler.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.ljpww72729.atblinkcontroler.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.ljpww72729.atblinkcontroler.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.ljpww72729.atblinkcontroler.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.ljpww72729.atblinkcontroler.EXTRA_DATA";
...
//            // TODO: 14/08/2017 此处处理CurrentTime的Characteristic
//            byte[] data = characteristic.getValue();
//            if (data != null && data.length > 0) {
//                final StringBuilder stringBuilder = new StringBuilder(data.length);
//                stringBuilder.append(((data[1] & 0xFF) << 8)+ (data[0] & 0xFF))
//                        .append("年 ")
//                        .append(data[2]).append("月 ")
//                        .append(data[3]).append("日 ")
//                        .append(data[4]).append("点 ")
//                        .append(data[5]).append("分 ")
//                        .append(data[6]).append("秒 星期")
//                        .append(data[7]).append(" ");
//                intent.putExtra(EXTRA_DATA, stringBuilder.toString());
//            }
//
//        }
        else if (BlinkProfile.BLINK_STATUS_CHAR.equals(characteristic.getUuid())) {
            byte[] data = characteristic.getValue();
            if (data != null && data.length > 0) {
                Blink blink = new Blink();
                blink.writeBytes(data);
