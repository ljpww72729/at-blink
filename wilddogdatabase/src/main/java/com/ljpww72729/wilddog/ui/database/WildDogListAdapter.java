 ...
 *            Firebase location
 */
public abstract class WildDogListAdapter<T> extends BaseAdapter implements WildDogAdapter<T> {
     ...
     *                    reflectively.
     */
    public WildDogListAdapter(Context context,
    ...
    /**
     * @see #WildDogListAdapter(Context, ObservableSnapshotArray, int, LifecycleOwner)
     */
    public WildDogListAdapter(Context context,
                              ObservableSnapshotArray<T> snapshots,
                              @LayoutRes int modelLayout) {
     ...
     * @see #WildDogListAdapter(Context, ObservableSnapshotArray, int)
     */
    public WildDogListAdapter(Context context,
                              SnapshotParser<T> parser,
                              @LayoutRes int modelLayout,
                              Query query) {
        this(context, new WildDogArray<>(query, parser), modelLayout);
    }

    /**
     * @see #WildDogListAdapter(Context, SnapshotParser, int, Query)
     * @see #WildDogListAdapter(Context, ObservableSnapshotArray, int, LifecycleOwner)
     */
    public WildDogListAdapter(Context context,
                              SnapshotParser<T> parser,
                              ...
                              Query query,
                              LifecycleOwner owner) {
        this(context, new WildDogArray<>(query, parser), modelLayout, owner);
    }
    ...
    /**
     * @see #WildDogListAdapter(Context, SnapshotParser, int, Query, LifecycleOwner)
     */
    public WildDogListAdapter(Context context,
                              Class<T> modelClass,
                              @LayoutRes int modelLayout,
