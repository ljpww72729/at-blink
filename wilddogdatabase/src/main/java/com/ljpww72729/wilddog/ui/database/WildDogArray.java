 ...
 */
public class WildDogArray<T> extends CachingObservableSnapshotArray<T> implements ChildEventListener, ValueEventListener {
     ...
     */
    public WildDogArray(Query query, Class<T> tClass) {
        super(tClass);
        init(query);
    }
     ...
     * @see WildDogArray#WildDogArray(Query, Class)
     */
    public WildDogArray(Query query, SnapshotParser<T> parser) {
        super(parser);
        init(query);
    }
    ...
    public boolean equals(Object obj) {
        ...
        WildDogArray snapshots = (WildDogArray) obj;
