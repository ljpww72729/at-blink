 ...
 * the list attach a {@link ChildEventListener}.
 *
...
public abstract class ObservableSnapshotArray<E> extends AbstractList<DataSnapshot> {
    ...
    /**
     * Detach a {@link ChildEventListener} from this array.
     */
    @CallSuper
    ...
    protected final void notifyListenersOnCancelled(SyncError error) {
        for (ChangeEventListener listener : mListeners) {
    ...
    /**
     * @return true if {@link WildDogArray} is listening for change events from the Firebase
